...
const initialState = {
    //Have a PHOTO array responsible for getting the data and setting to the array.
    photos: {},
...
const GET_PHOTO_FULFILLED = 'GET_PHOTO_FULFILLED';
//When there is a error return an errror action type. 
const GET_PHOTO_REJECTED = 'GET_PHOTO_REJECTED';
...
const reducer = (state = initialState, action) => {
    switch(action.type) {
        ...
        return {...state, photos: action.payload, loading: action.loading};
